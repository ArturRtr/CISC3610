function changeCanvasColor(){
    ...
    function BoatCar(x){
        ...
        context.fillRect(x-75,720,40,20);
        context.beginPath();
        context.fillStyle = "yellow";
        context.fillRect(x,710,15,50);
        context.beginPath();
        context.fillStyle = "yellow";
        context.fillRect(x,720,30,2);
        //boat  
        context.beginPath();
        context.arc(x, 730, 50, 0, Math.PI);
        context.fillStyle = "white";
        context.fill();
        context.beginPath();
        context.arc(x-12, 745, 35, 0, Math.PI);
        ...
        context.fill();
        context.beginPath();
        context.arc(x, 745, 35, 0, Math.PI);
        context.fillStyle = "red";
        context.fill();
        //wheels
        context.beginPath();
        context.arc(x-25, 775, 15, 0, 2 * Math.PI);
        context.fillStyle = "gray";
        context.fill();
        context.beginPath();
        context.arc(x-25, 775, 8, 0, 2 * Math.PI);
        context.fillStyle = "black";
        context.fill();
    ...
    // let x = 100;
    // for(let i = x; i<canvas.width+100; i++){
    //     BoatCar(x);
    //     x++;
    // }
    var x = 100;
    function MoveBoat(){
        ...
        context.clearRect(0,700,canvas.width,canvas.height);
        // for(let i = x; i<canvas.width+100; i++){
        //     BoatCar(x);
        //     x++;
